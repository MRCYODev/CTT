            ...
            items: [
                {
                    type: 'category',
                    label: 'Utilities',
                    description: 'Utilities for system maintenance, recovery, conversion, and other technician tasks.',
                    collapsible: true,
                    collapsed: true,
                    link: {
                        type: 'doc',
                ...
                },
                {
                    type: 'category',
                    label: 'Diagnostics',
                    description: 'Hardware, software, system, and troubleshooting diagnostic tools.',
                    collapsible: true,
                    collapsed: true,
                    link: {
                        type: 'doc',
